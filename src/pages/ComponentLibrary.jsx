  ...
  const renderModernFormsSection = () => (
    <ComponentSection title="Modern Forms" id="modern-forms">
      <div className="space-y-8">
        {/* Select Component */}
        <div className="space-y-4">
          <h3 className="text-lg font-medium text-gray-900 dark:text-white">Select</h3>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="space-y-2">
              ...
              <Select size="sm" value={selectValue} onValueChange={setSelectValue}>
                <Option value="">Choose an option</Option>
            ...
            <div className="space-y-2">
              ...
              <Select size="lg" value={selectValue} onValueChange={setSelectValue}>
                <Option value="">Choose an option</Option>
        ...
        {/* Checkbox Component */}
        <div className="space-y-4">
          <h3 className="text-lg font-medium text-gray-900 dark:text-white">Checkbox</h3>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <Checkbox 
              checked={checkboxes.basic}
              onCheckedChange={(checked) => setCheckboxes(prev => ({...prev, basic: checked}))}
              label="Basic checkbox"
            />
            <Checkbox 
              checked={checkboxes.withLabel}
              onCheckedChange={(checked) => setCheckboxes(prev => ({...prev, withLabel: checked}))}
              label="With description"
              description="This checkbox has a description"
            />
            <Checkbox 
              checked={checkboxes.error}
              onCheckedChange={(checked) => setCheckboxes(prev => ({...prev, error: checked}))}
              label="Error state"
              error
            />
            <Checkbox 
              checked={checkboxes.success}
              onCheckedChange={(checked) => setCheckboxes(prev => ({...prev, success: checked}))}
              label="Success state"
              success
            />
          </div>
        ...
        {/* Radio Component */}
        <div className="space-y-4">
          <h3 className="text-lg font-medium text-gray-900 dark:text-white">Radio Groups</h3>
          <RadioGroup>
            <Radio 
              name="example"
              value="option1"
        ...
        {/* Switch Component */}
        <div className="space-y-4">
          <h3 className="text-lg font-medium text-gray-900 dark:text-white">Switch</h3>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <Switch 
              checked={switchStates.basic}
              onCheckedChange={(checked) => setSwitchStates(prev => ({...prev, basic: checked}))}
              label="Basic switch"
            />
            <Switch 
              checked={switchStates.withLabel}
              onCheckedChange={(checked) => setSwitchStates(prev => ({...prev, withLabel: checked}))}
              label="With description"
              description="This switch has a description"
            />
            <Switch 
              checked={switchStates.success}
              onCheckedChange={(checked) => setSwitchStates(prev => ({...prev, success: checked}))}
              label="Success variant"
              variant="success"
            />
            <Switch 
              checked={switchStates.danger}
              onCheckedChange={(checked) => setSwitchStates(prev => ({...prev, danger: checked}))}
        ...
        <div className="space-y-4">
          <h3 className="text-lg font-medium text-gray-900 dark:text-white">Form Field Composition</h3>
                  ...
                  <ModernInput 
                    ...
                    onChange={(e) => {
                      if (e.target.value.length < 8) {
                        setModernInputError('Password must be at least 8 characters');
                      } else {
                        setModernInputError('');
                      }
                    }}
  ...
  const renderNavigationSection = () => (
    <ComponentSection title="Navigation" id="navigation">
      <div className="space-y-8">
        {/* Tabs Component */}
        <div className="space-y-4">
          <h3 className="text-lg font-medium text-gray-900 dark:text-white">Tabs</h3>
          <div className="space-y-6">
            <Tabs value={activeModernTab} onValueChange={setActiveModernTab}>
              ...
              <TabsContent value="tab1">
                <div className="rounded-lg border border-gray-200 dark:border-gray-700 p-6">
                  ...
                  <p className="text-gray-600 dark:text-gray-400">This is the content for tab 1.</p>
                </div>
              </TabsContent>
              <TabsContent value="tab2">
                <div className="rounded-lg border border-gray-200 dark:border-gray-700 p-6">
                  <h4 className="font-medium mb-2">Tab 2 Content</h4>
                  <p className="text-gray-600 dark:text-gray-400">This is the content for tab 2.</p>
                </div>
              </TabsContent>
              <TabsContent value="tab3">
                <div className="rounded-lg border border-gray-200 dark:border-gray-700 p-6">
                  <h4 className="font-medium mb-2">Tab 3 Content</h4>
                  <p className="text-gray-600 dark:text-gray-400">This is the content for tab 3.</p>
                </div>
              </TabsContent>
            </Tabs>
          </div>
        ...
        <div className="space-y-4">
          <h3 className="text-lg font-medium text-gray-900 dark:text-white">Breadcrumb</h3>
          <div className="space-y-4">
            <Breadcrumb>
              <BreadcrumbList>
                <BreadcrumbItem>
        ...
        {/* Layout Components */}
        <div className="space-y-4">
          <h3 className="text-lg font-medium text-gray-900 dark:text-white">Layout Components</h3>
          <div className="space-y-6">
            <div>
              <h4 className="font-medium mb-3">Container</h4>
              <Container size="md" className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
            ...
            <div>
              ...
              <Grid cols={3} gap="md">
                <div className="bg-blue-100 dark:bg-blue-900 rounded-lg p-4 text-center">Item 1</div>
                <div className="bg-green-100 dark:bg-green-900 rounded-lg p-4 text-center">Item 2</div>
                <div className="bg-purple-100 dark:bg-purple-900 rounded-lg p-4 text-center">Item 3</div>
              </Grid>
            </div>
            ...
            <div>
              ...
              <VStack gap="md">
                <div className="bg-red-100 dark:bg-red-900 rounded-lg p-4 text-center">Vertical Item 1</div>
                <div className="bg-yellow-100 dark:bg-yellow-900 rounded-lg p-4 text-center">Vertical Item 2</div>
              </VStack>
            </div>
          </div>
        </div>
      ...
      <div className="space-y-8">
        <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6">
          ...
          <p className="text-blue-700 dark:text-blue-300 mb-6">
            This section demonstrates how our modern UI components work together in real-world scenarios.
          </p>
          
          {/* Complex Form Integration */}
          <div className="bg-white dark:bg-black rounded-lg p-6 shadow-sm">
            <h4 className="font-medium mb-4">User Profile Form</h4>
            <Container size="lg">
              <Grid cols={2} gap="lg">
                <ModernFormField>
                  <FormItem>
              ...
              <Tabs defaultValue="personal" className="mt-6">
                ...
                <TabsContent value="security">
                  <div className="space-y-4 mt-4">
                    <ModernInput type="password" placeholder="Current password" />
        ...
        <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-6">
          ...
          <Grid cols={3} gap="md">
            <div className="bg-white dark:bg-black rounded-lg p-4 text-center">
              <div className="text-2xl font-bold text-green-600">13</div>
              <div className="text-sm text-gray-600 dark:text-gray-400">Modern Components</div>
            </div>
            <div className="bg-white dark:bg-black rounded-lg p-4 text-center">
              <div className="text-2xl font-bold text-blue-600">99%</div>
              <div className="text-sm text-gray-600 dark:text-gray-400">TypeScript Coverage</div>
            </div>
            <div className="bg-white dark:bg-black rounded-lg p-4 text-center">
              <div className="text-2xl font-bold text-purple-600">A11y</div>
              <div className="text-sm text-gray-600 dark:text-gray-400">Accessibility Ready</div>
            </div>
          </Grid>
        </div>
      </div>
          ...
          <div className="rounded-lg bg-white p-6 shadow-sm dark:bg-[#0F0F0F] lg:col-span-3">
            {activeTab === 'atomic' && (
              <>
                ...
                {activeSection === 'integration-tests' && renderIntegrationTestsSection()}
              </>
            )}
