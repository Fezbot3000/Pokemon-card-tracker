        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-3">
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-xl border border-gray-800 px-4 py-3 text-white transition-colors hover:bg-gray-900 disabled:opacity-50"
              disabled={isLoading}
            >
              {isLoading ? (
                <>
                  <svg className="size-5 animate-spin text-gray-700 dark:text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                ...
                <>
                  <svg className="mr-2 size-5" aria-hidden="true" viewBox="0 0 24 24">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <Toggle
                ...
                labelPosition="right"
              />
              <label htmlFor="remember-me" className="ml-2 cursor-pointer text-sm text-gray-300">
                Remember me
              </label>
            </div>
            <button
