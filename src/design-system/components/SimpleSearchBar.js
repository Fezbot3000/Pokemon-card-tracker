    ...
    <div className={containerClass} {...props}>
      ...
      <div className="relative w-full">
        ...
        <input
          ...
          className="w-full rounded-lg border border-gray-300 bg-white py-2 pl-10 pr-4 text-gray-900 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 dark:border-gray-600 dark:bg-[#0F0F0F] dark:text-white dark:placeholder:text-gray-400 dark:focus:bg-[#0F0F0F]"
