  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <ColorCategory title="Grays">
        <ColorSwatch colorValue={baseColors.gray50} name="Gray 50" />
        <ColorSwatch colorValue={baseColors.gray100} name="Gray 100" />
        <ColorSwatch colorValue={baseColors.gray200} name="Gray 200" />
        <ColorSwatch colorValue={baseColors.gray300} name="Gray 300" />
        <ColorSwatch colorValue={baseColors.gray400} name="Gray 400" />
        <ColorSwatch colorValue={baseColors.gray500} name="Gray 500" />
        <ColorSwatch colorValue={baseColors.gray600} name="Gray 600" />
        <ColorSwatch colorValue={baseColors.gray700} name="Gray 700" />
        <ColorSwatch colorValue={baseColors.gray800} name="Gray 800" />
        <ColorSwatch colorValue={baseColors.gray900} name="Gray 900" />
        <ColorSwatch colorValue={baseColors.gray950} name="Gray 950" />
      </ColorCategory>
      ...
      <ColorCategory title="Status Colors">
        <ColorSwatch colorValue={baseColors.success} name="Success" />
        <ColorSwatch colorValue={baseColors.error} name="Error" />
        <ColorSwatch colorValue={baseColors.warning} name="Warning" />
        <ColorSwatch colorValue={baseColors.info} name="Info" />
      </ColorCategory>
