...
const BottomSheet = ({ isOpen, onClose, title, children }) => {
  ...
  return (
    ...
    >
      {/* Sheet Content */}
      <div 
        className="w-full bg-white dark:bg-gray-800 rounded-t-xl shadow-xl transform transition-all duration-300 ease-in-out pt-3 pb-4 px-3"
      ...
      >
        ...
        {(title || onClose) && (
          <div className="flex justify-between items-center mb-3 px-1">
            <h3 className="text-base font-semibold text-gray-700 dark:text-gray-300 text-center flex-grow">
              {title}
            </h3>
