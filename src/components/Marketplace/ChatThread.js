        ...
        {loading ? (
          ...
          messages.map(message => {
            ...
            const isFromCurrentUser =
              !isSystemMessage && message.senderId === user?.uid;
      ...
      {otherPartyLeft && (
        <div className="border-y border-yellow-100 bg-yellow-50 p-2 dark:border-yellow-900/30 dark:bg-yellow-900/20">
          <p className="text-center text-xs text-yellow-700 dark:text-yellow-500">
            The other party has left this chat. You can still view the
            conversation but no new messages can be sent.
          </p>
        </div>
      )}
      ...
      >
        ...
        <div className="flex items-center space-x-2">
          ...
          <button
            ...
            disabled={
              !newMessage.trim() || sending || hasLeft || otherPartyLeft
            }
          >
