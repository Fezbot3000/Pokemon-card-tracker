  ...
  const marketTrends = [
    {
      ...
      description:
        'Pokemon cards saw 300-500% price increases due to celebrity endorsements and pandemic collecting',
      impact: 'High',
    },
    {
      period: '2022-2023',
      ...
      description:
        'Prices stabilized and corrected 20-40% from peak highs, creating buying opportunities',
      impact: 'Medium',
    },
    {
      period: '2024+',
      ...
      description:
        'High-grade vintage and key modern cards continue appreciating while lower-tier cards plateau',
      impact: 'Medium-High',
    },
  ];
      ...
      <section className="relative px-4 pb-16 pt-32 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl text-center">
          ...
          <p className="mx-auto mb-8 max-w-3xl text-xl text-gray-300">
            Master the art of Pokemon card investing with data-driven
            strategies, market analysis, and ROI insights for Australian
            collectors.
          </p>
              ...
              <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
                <div className="bg-white/5 rounded-xl p-6">
                  ...
                  <ul className="space-y-3 text-gray-300">
                    <li>
                      • <strong>Proven Track Record:</strong> Base Set
                      Charizard: $6 (1998) → $350,000+ (2022)
                    </li>
                    <li>
                      • <strong>Global Demand:</strong> 25+ years of sustained
                      popularity across generations
                    </li>
                    <li>
                      • <strong>Limited Supply:</strong> Vintage cards have
                      fixed, diminishing supply
                    </li>
                    <li>
                      • <strong>Grading Premium:</strong> PSA 10 cards command
                      5-20x raw card prices
                    </li>
                    <li>
                      • <strong>Cultural Impact:</strong> Pokemon remains the
                ...
                <div className="bg-white/5 rounded-xl p-6">
                  ...
                  <ul className="space-y-3 text-gray-300">
                    <li>
                      • <strong>Market Volatility:</strong> Prices can fluctuate
                      20-50% year-over-year
                    </li>
                    <li>
                      • <strong>Condition Sensitivity:</strong> Small condition
                      differences = massive value gaps
                    </li>
                    <li>
                      • <strong>Authentication Risk:</strong> Fake cards and
                      altered grades exist
                    </li>
                    <li>
                      • <strong>Liquidity Concerns:</strong> High-value cards
                      can take months to sell
                    </li>
                    <li>
                      • <strong>Storage Costs:</strong> Proper storage and
                      insurance required
                    </li>
                  </ul>
                </div>
            ...
            <div className="space-y-8">
              ...
              <div className="rounded-xl border border-green-500/30 bg-gradient-to-r from-green-500/20 to-blue-500/20 p-8">
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  <div>
                    <h4 className="mb-3 font-bold text-green-400">
                      Bullish Factors
                    </h4>
                  ...
                  <div>
                    <h4 className="mb-3 font-bold text-red-400">
                      Bearish Risks
                    </h4>
                    <ul className="space-y-2 text-gray-300">
                      <li>
          ...
          <div className="mt-16 text-center">
            <div className="rounded-2xl border border-purple-500/30 bg-gradient-to-r from-purple-500/20 to-blue-500/20 p-8">
              ...
              <p className="mb-6 text-gray-300">
                Track your investments, monitor market trends, and maximize your
                ROI with our advanced Pokemon Card Tracker.
              </p>
              <Link
                to="/login"
