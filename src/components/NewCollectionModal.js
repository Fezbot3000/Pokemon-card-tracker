    ...
    >
      <div className="space-y-4">
        <div>
          ...
          <input
            type="text"
            className="border-gray-200/20 dark:border-gray-700/10 focus:ring-primary/20 w-full rounded-lg border bg-white px-3 py-2 text-gray-900 placeholder:text-gray-500 focus:border-primary focus:outline-none focus:ring-2 dark:bg-[#0F0F0F] dark:text-white dark:placeholder:text-gray-400"
