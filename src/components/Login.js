      ...
      <div className="max-w-md w-full bg-white dark:bg-[#1B2131] rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="px-6 pb-8">
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <button
              type="button"
              className="w-full flex justify-center py-3 px-4 border border-gray-300 dark:border-gray-700 rounded-xl shadow-sm bg-white dark:bg-[#252B3B] text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-[#323B4B]"
            >
