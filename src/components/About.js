  ...
  const milestones = [
    {
      ...
      title: 'The Beginning',
      description:
        'Started as a personal project to track a growing collection',
      icon: '🌱',
    },
    {
      year: '2021',
  ...
  const values = [
    {
      ...
      description:
        'Every feature is designed with collectors in mind, built by collectors for collectors.',
      icon: '🎯',
    },
    {
      title: 'Trust & Security',
      description:
        'Your collection data and transactions are protected with enterprise-grade security.',
      icon: '🔒',
    },
    {
      title: 'Innovation',
      description:
        'We continuously innovate to bring cutting-edge tools to the collecting community.',
      icon: '💡',
    },
    {
      title: 'Community',
      description:
        'Building a global community where collectors can connect, trade, and grow together.',
      icon: '🤝',
    },
    {
      title: 'Transparency',
      description:
        'Open communication about our platform, pricing, and future development.',
      icon: '🔍',
    },
    {
      title: 'Excellence',
      ...
      <section className="relative overflow-hidden px-4 pb-16 pt-24 md:pb-24 md:pt-32 sm:px-6 sm:pb-20 sm:pt-28 lg:px-8">
        ...
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mb-8 max-w-3xl text-base leading-relaxed text-gray-300 md:text-xl sm:mb-12 sm:text-lg lg:text-2xl">
            We're on a mission to empower collectors worldwide with
            professional-grade tools to manage, track, and grow their
            collections.
          </p>
        </div>
      </section>
      ...
      <section className="bg-black px-4 py-12 md:py-24 sm:px-6 sm:py-16 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
            <div>
              <h2 className="mb-6 text-2xl font-bold md:text-4xl sm:text-3xl">
                Our Story
              </h2>
              <div className="space-y-6 leading-relaxed text-gray-300">
                <p>
                  Collectibles Tracker was born from a simple frustration: the
                  lack of professional tools for serious collectors. Our
                  founder, Matthew, was managing a growing collection using
                  spreadsheets and basic apps that couldn't handle the
                  complexity of modern collecting.
                </p>
                <p>
                  What started as a personal project quickly evolved into
                  something bigger when other collectors saw the potential. We
                  realized that collectors deserved better than makeshift
                  solutions – they needed professional-grade tools that could
                  handle everything from basic tracking to advanced portfolio
                  analytics.
                </p>
                <p>
                  Today, we're proud to serve over 50,000 collectors worldwide,
                  helping them manage collections worth millions of dollars. Our
                  platform has facilitated thousands of secure transactions and
                  helped collectors make informed decisions about their
                  investments.
                </p>
                <p>
                  But we're just getting started. Our vision is to become the
                  global standard for collection management, connecting
                  collectors worldwide and providing the tools they need to
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center sm:mb-16">
            ...
            <p className="mx-auto max-w-2xl text-base text-gray-300 sm:text-lg">
              Guided by principles that put collectors first and drive
      ...
      <section className="bg-black px-4 py-12 md:py-24 sm:px-6 sm:py-16 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center sm:mb-16">
            ...
            <p className="mx-auto max-w-2xl text-base text-gray-300 sm:text-lg">
              Passionate collectors and technologists working to build the
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
            <div>
              ...
              <div className="space-y-6 leading-relaxed text-gray-300">
                <p>
                  Our platform is built on modern, scalable technology that
                  ensures reliability, security, and performance. We use
                  industry-leading practices to protect your data and provide a
                ...
                <div className="space-y-3">
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-300">
                      Best Collectibles App 2024 - Collectors Choice Awards
                    </span>
                  </div>
                  <div className="flex items-center">
                    <span className="mr-3 size-2 rounded-full bg-yellow-400"></span>
                    <span className="text-gray-300">
                      Innovation in FinTech 2023 - TechCrunch
                    </span>
                  </div>
                  <div className="flex items-center">
                    <span className="mr-3 size-2 rounded-full bg-yellow-400"></span>
                    <span className="text-gray-300">
                      Top Startup 2022 - Australian Tech Awards
                    </span>
                  </div>
                </div>
              </div>
      ...
      <section className="bg-black px-4 py-12 md:py-24 sm:px-6 sm:py-16 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mb-8 max-w-2xl text-base text-gray-300 md:text-xl sm:mb-12 sm:text-lg">
            Become part of a global community of collectors who trust
            Collectibles Tracker to manage their valuable collections.
          </p>
