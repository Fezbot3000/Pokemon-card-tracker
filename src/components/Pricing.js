            ...
            {plans.map((plan, index) => (
              ...
              >
                ...
                <div className="mb-6 text-center lg:mb-8">
                  <h3 className="mb-2 text-xl font-bold text-white lg:text-2xl">{plan.name}</h3>
                  <div className="mb-2">
                    <span className="text-3xl font-bold text-white lg:text-4xl">{plan.price}</span>
                    {plan.period && <span className="ml-2 text-gray-400">/{plan.period}</span>}
                  </div>
                  <p className="text-sm text-gray-300 lg:text-base">{plan.description}</p>
                </div>
                ...
                <ul className="mb-6 space-y-3 lg:mb-8 lg:space-y-4">
                  {plan.features.map((feature, featureIndex) => (
                    <li key={featureIndex} className="flex items-start">
                      ...
                      <span className="text-sm text-gray-300 lg:text-base">{feature}</span>
                    </li>
                  ))}
                </ul>
      ...
      <section className="bg-black px-4 py-12 sm:px-6 sm:py-16 md:py-24 lg:px-8">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="space-y-6">
            {faqs.map((faq, index) => (
              <div key={index} className="from-white/10 to-white/5 border-white/10 rounded-2xl border bg-gradient-to-br p-6 backdrop-blur-sm lg:p-8">
                <h3 className="mb-3 text-lg font-semibold text-white lg:mb-4 lg:text-xl">{faq.question}</h3>
                <p className="text-sm leading-relaxed text-gray-300 lg:text-base">{faq.answer}</p>
              </div>
            ))}
          </div>
        </div>
