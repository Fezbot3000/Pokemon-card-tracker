 ...
 */
export const formatStatisticsForDisplay = (totals, cardCount, displayedCount) => {
  return [
    {
      label: 'Paid',
    ...
    },
    {
      ...
      value: cardCount,
      icon: 'style',
      subtitle: displayedCount < cardCount ? `Showing ${displayedCount} of ${cardCount}` : undefined
    }
  ];
};
